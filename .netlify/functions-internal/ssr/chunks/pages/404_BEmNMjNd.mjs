...
const $$Navigation = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div id="main-navigation" class="is-desktop py-8"> <div class="container"> <a href="/" class="flex items-center gap-2 !no-underline"> ${renderComponent($$result, "Image", $$Image, { "src": logo, "alt": "Your Logo", "width": "30", "height": "37" })} </a> <div class="wrapper"> <nav class="desktop-menu" aria-label="Main navigation desktop"> <ul class="menu"> ${renderSlot($$result, $$slots["default"])} </ul> </nav> ${renderComponent($$result, "DarkMode", $$DarkMode, {})} ${renderComponent($$result, "ResponsiveToggle", $$ResponsiveToggle, {})} </div> <nav class="mobile-menu" aria-label="Main navigation mobile"> <ul class="menu"> ${renderSlot($$result, $$slots["default"])} </ul> </nav> </div> </div>  `;
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="m-4 rounded-lg bg-white shadow dark:bg-gray-900"> ${renderComponent($$result, "CallToAction", $$CallToAction, {})} <div class="mx-auto w-full max-w-screen-xl p-4 md:py-8"> <div class="sm:flex sm:items-center sm:justify-between"> <a href="https://flowbite.com/" class="mb-4 flex items-center space-x-3 sm:mb-0 rtl:space-x-reverse"> <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo"> <span class="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">Flowbite</span> </a> <ul class="mb-6 flex flex-wrap items-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:mb-0"> <li> <a href="#" class="me-4 hover:underline md:me-6">About</a> </li> <li> <a href="#" class="me-4 hover:underline md:me-6">Privacy Policy</a> </li> <li> <a href="#" class="me-4 hover:underline md:me-6">Licensing</a> </li> <li> <a href="#" class="hover:underline">Contact</a> </li> </ul> </div> <hr class="my-6 border-gray-200 dark:border-gray-700 sm:mx-auto lg:my-8"> <span class="block text-sm text-gray-500 dark:text-gray-400 sm:text-center">© 2024 <a href="https://flowbite.com/" class="hover:underline">Flowbite™</a>. All Rights Reserved.</span> </div> </footer>`;
...
export { $$DefaultLayout as $, _404 as _, $$Breadcrumbs as a, $$BreadcrumbsItem as b, $$Accordion as c, $$AccordionItem as d, $$Card as e, $$Media as f, $$Modal as g, $$Notification as h, $$Pagination as i, getConfiguredImageService as j, imageConfig as k, $$Image as l };
